package app.cosmos.ghrealestatediary.materialrangebar;
...
import app.cosmos.ghrealestatediary.R;
...
class PinView extends View {
    ...
    public void setFormatter(app.cosmos.ghrealestatediary.materialrangebar.IRangeBarFormatter mFormatter) {
