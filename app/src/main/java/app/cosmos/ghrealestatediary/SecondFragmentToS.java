...
public class SecondFragmentToS extends Fragment {

    Context context;
    View view;
    TextView second_tos_txt;
    AQuery aQuery = null;


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_second_tos, container, false);
        ...
        second_tos_txt = view.findViewById(R.id.second_tos_txt);

        aQuery = new AQuery(context);
        String url = UrlManager.getBaseUrl() + "main/policy/2";
        try {
                        ...
                        public void run() {
                            try {
                                ...
                                if (jsonObject.getBoolean("return")) {    //return이 true 면?
                                    second_tos_txt.setText(jsonObject.getJSONObject("data").getString("content"));
